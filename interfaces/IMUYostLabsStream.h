...
#ifndef IMUYOSTLABSSTREAM_H
#define IMUYOSTLABSSTREAM_H
...
class IMUYOSTLABS_EXPORT_API IMUYostLabsStream : public org::bcom::xpcf::ComponentBase,
        public api::input::devices::IIMU {
public:
    IMUYostLabsStream();

    ~IMUYostLabsStream() = default;
